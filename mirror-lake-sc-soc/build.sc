...
object mirrorlakescsoc extends ScalaModule with BaseProject with ScalacOptions {
  // This is the name of your main class (instantiated as `object x extends App`)
  def mainClass = Some("mirrorlakescsoc.MirrorLakeSCSoC")
  // Matches your project directory where sources and tests are placed
  def projectName = "mirrorlakescsoc"
}
...
// The mirrorlakescsoc alias runner
